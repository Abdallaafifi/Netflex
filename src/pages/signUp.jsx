        ...
        <div className="max-w-[420px] h-[600px] bg-black/70 mx-auto p-12">
          ...
          <form onSubmit={handelSubmit}>
            <input
              ...
              type="email"
              className="bg-black_dim border-none text-sm px-3 py-4 md:py-4 w-full text-[15px]  mb-6 rounded  text-white/90"
            />
            <input
            ...
            <p className="text-dimWhite/50 text-[13px] capitalize mt-8 ">
